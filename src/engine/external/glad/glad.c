/*
    ...
    OpenGL loader generated by glad 0.1.36 on Mon Apr 28 23:13:14 2025.
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c" --spec="gl" --local-files --extensions="GL_ARB_bindless_texture,GL_ARB_debug_output"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.6&extensions=GL_ARB_bindless_texture&extensions=GL_ARB_debug_output
*/
